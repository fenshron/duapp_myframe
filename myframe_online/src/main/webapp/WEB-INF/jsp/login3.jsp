...
<html >
  <head>
    <meta charset="UTF-8">
    <title>用户登录</title>
    <script type="text/javascript" name="baidu-tc-cerfication" data-appid="6950115" src="http://apps.bdimg.com/cloudaapi/lightapp.js"></script>
	   ...
	   <form id="user_login_loginForm" method="post" action="dologin.htm">
	    <div class="profile__form">
	      <div class="profile__fields">
	        <div class="field">
	          <input  type="text" id="fieldUser" name="userAccount" class="input" required pattern=.*\S.* />
	          <label for="fieldUser" class="label">用户名</label>
	        </div>
	        <div class="field">
	          <input  type="password" id="fieldPassword" name="userPassword" class="input" required pattern=.*\S.* />
