...
<html>
  <head>
    ...
    <title>我的主页</title>
    <link href="../../common/images/favicon.ico" type="image/x-icon">
...
<body class="easyui-layout" style="background: linear-gradient(to bottom, #68EACC 0%, #497BE8 100%);">
	<div data-options="region:'north',border:false" style="height:60px;background:transparent;padding:10px;position: relative;">
		<div style="float:left;width:14%;height:40px;font-size:28px; font-weight: bold;">myframe</div>
		<div style="float:left;height:40px;text-align:right;line-height:25px;padding:0 5px; position: absolute;right: 10;">
			<label id="time"></label>
	...
	<div data-options="region:'west',split:true,title:'导航'" style="width:200px;padding:10px;">
		<ul class="easyui-tree" id="menutree"  url="pageMenu.htm"  data-options="lines:true,parentField:'pid'"></ul>
	</div>
	<div data-options="region:'east',split:true,collapsed:true,title:'East'" style="width:100px;padding:10px;">east region</div>
	<div data-options="region:'south',border:false" style="height:40px;background:transparent;padding:10px;">fengshirong 2016 502109651@qq.com</div>
